...
module.exports = {
	...
	async execute(interaction) {
        ...
        const message = '@Esports Predictors' + '\n' + '\n' + 
        ...
        'If you would like to receive pings when predictions are  posted, you can go to Customize Community to be added to the Esports Predictors role.';
